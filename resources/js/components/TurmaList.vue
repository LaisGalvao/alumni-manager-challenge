<template>
    <div>
        ...
        <table class="table">
            ...
            <tbody>
                <tr v-for="turma in paginatedTurmas" :key="turma.id">
                    <td>{{ turma.nome }}</td>
                    <td>{{ turma.descricao }}</td>
                    <td>{{ turma.tipo }}</td>
                    <td>
                        <button @click="editTurma(turma)" class="btn btn-primary">Editar</button>
                        <button @click="deleteTurma(turma.id)" class="btn btn-danger">Excluir</button>
                    </td>
                </tr>
            </tbody>
        </table>
...
export default {
    ...
    computed: {
        ...
        totalPages() {
            return Math.ceil(this.filteredTurmas.length / this.itemsPerPage);
        },
        paginatedTurmas() {
